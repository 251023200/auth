...
import com.sky.auth.permission.domain.MenuPermission;
...
public interface MenuPermissionDao extends BaseDao<MenuPermission>{
	...
	public MenuPermission getByRoleIdAndMenuId(@Param("roleId")String roleId,@Param("menuId")String menuId);	//通过用户编号和角色编号查找
	...
	public int batchInsert(List<MenuPermission> MenuPermissions);
